export KSC_APT_LIBS="software-properties-common gnupg2 less ufw ack-grep libfuse2
...
export KSC_APT_LANGUAGES="ruby ruby-dev golang php python3 python3-pip python-dev
                          python3-dev python-pip python3-neovim nodejs"

export KSC_APT_TOOLS="curl tmux git vim zsh sqlite3 ctags rdoc libsqlite3-dev
